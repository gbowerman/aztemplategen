...
Template deployment example using CLI. Pipe output of above program to a file called testplate.json..

```
az group create -n testplace -l southcentralus
az group deployment create --name testplate --resource-group te
stplace --template-file .\testplate.json
```
